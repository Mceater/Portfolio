  ...
  return (
    <section id="contact" className="py-24 bg-gray-100 dark:bg-gray-800 text-center px-6">
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
        ...
        <a href="mailto:farhanrisan@gmail.com" className="flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-green-600 hover:bg-green-700 text-white transition-all duration-200 hover:scale-105">
